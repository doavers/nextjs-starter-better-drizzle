...
export function DataTableToolbar<TData>({ data, table, children, className, ...props }: DataTableToolbarProps<TData>) {
  ...
  return (
    <div
      ...
      className={cn("mx-4 flex items-start justify-between gap-2 p-1 md:mx-6 lg:mx-8", className)}
      {...props}
    >
      ...
      <div className="flex items-center gap-2">
        {children}
        <Button className="mr-2" onClick={() => exportToCSV(data, "export_data")}>
          Export to CSV
        </Button>
        <Button className="mr-2" onClick={() => exportToXLSX(data, "export_data")}>
          Export to XLSX
        </Button>
