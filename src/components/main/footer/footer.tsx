...
const Footer = async () => {
  ...
  return (
    <footer className="wow fadeInUp relative z-10 bg-[#090E34] pt-20 lg:pt-[100px]" data-wow-delay=".15s">
      <div className="mx-auto max-w-screen-xl px-4">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-4/12">
            <div className="mb-10 w-full">
              ...
              <div className="-mx-3 flex items-center">
                <Link aria-label="social link" href="#" className="px-3 text-gray-300 hover:text-white">
                  <svg
                    width="22"
                    height="22"
                    viewBox="0 0 22 22"
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-white">{t("about-us")}</h4>
              <ul>
                <li>
                  <Link href="/" className="mb-3 inline-block text-base text-gray-300 hover:text-slate-500">
                    {t("home")}
                  </Link>
                </li>
                <li>
                  <Link href="/about" className="mb-3 inline-block text-base text-gray-300 hover:text-slate-500">
                    {t("about")}
                  </Link>
                </li>
                <li>
                  <Link href="/portfolio" className="mb-3 inline-block text-base text-gray-300 hover:text-slate-500">
                    {t("portfolio")}
                  </Link>
                </li>
                <li>
                  <Link
                    href="/#testimonials"
                    className="mb-3 inline-block text-base text-gray-300 hover:text-slate-500"
                  >
                    {t("testimonials")}
                  </Link>
                </li>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-white">{t("features")}</h4>
              <ul>
                <li>
                  <Link href="/services" className="mb-3 inline-block text-base text-gray-300 hover:text-slate-500">
                    {t("services")}
                  </Link>
                </li>
                <li>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-white">{t("useful-links")}</h4>
              <ul>
                <li>
                  <Link href="/#faq" className="mb-3 inline-block text-base text-gray-300 hover:text-slate-500">
                    {t("faq")}
                  </Link>
                </li>
                <li>
                  <Link href="/blog" className="mb-3 inline-block text-base text-gray-300 hover:text-slate-500">
                    {t("blog")}
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className="mb-3 inline-block text-base text-gray-300 hover:text-slate-500">
                    {t("support")}
                  </Link>
                </li>
              </ul>
      ...
      <div className="border-opacity-40 mt-12 border-t border-[#8890A4] py-8 lg:mt-[60px]">
        <div className="mx-auto max-w-screen-xl px-4">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-2/3 lg:w-1/2">
              <div className="my-1">
                <div className="-mx-3 flex items-center justify-center md:justify-start">
                  <Link href="#" className="px-3 text-base text-gray-300 hover:text-white hover:underline">
                    {t("privacy-policy")}
                  </Link>
                  <Link href="#" className="px-3 text-base text-gray-300 hover:text-white hover:underline">
                    {t("legal-notice")}
