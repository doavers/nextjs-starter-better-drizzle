const Newsletter = () => {
  return (
    <div
      ...
      data-wow-delay=".1s"
    >
      <h3 className="mb-[6px] text-[28px] leading-[40px] font-semibold text-white">Join our newsletter!</h3>
      ...
      <form>
        ...
        <input
          type="submit"
          value="Subscribe Now"
          className="bg-secondary hover:bg-opacity-90 mb-4 h-[50px] w-full cursor-pointer rounded-md text-center text-sm font-medium text-white transition duration-300 ease-in-out hover:bg-gray-500"
        />
      </form>
