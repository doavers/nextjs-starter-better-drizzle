...
const SingleTeam = ({ team }: { team: TeamType }) => {
  const { image, name, designation, facebookLink, twitterLink, instagramLink } = team;
  return (
    <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
      <div className="group shadow-testimonial mb-8 rounded-xl bg-white px-5 pt-12 pb-10 dark:bg-black dark:shadow-none">
        <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
          <Image src={image} alt={name} className="w-full rounded-full" width={120} height={120} />
        ...
        <div className="text-center">
          <h3 className="mb-1 text-lg font-semibold text-black dark:text-white">{name}</h3>
          <p className="mb-5 text-sm dark:text-gray-200">{designation}</p>
          <div className="flex items-center justify-center gap-5">
            <Link aria-label="social link" href={facebookLink} className="text-black-6 hover:text-primary">
              <svg
                width="18"
                height="18"
                viewBox="0 0 18 18"
            ...
            <Link aria-label="social link" href={twitterLink} className="text-black-6 hover:text-primary">
              <svg
                width="18"
                height="18"
                viewBox="0 0 18 18"
            ...
            <Link aria-label="social link" href={instagramLink} className="text-black-6 hover:text-primary">
              <svg
                width="18"
                height="18"
                viewBox="0 0 18 18"
