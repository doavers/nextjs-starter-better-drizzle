...
const presetDir = path.resolve(dirname, "../styles/presets");
...
const outputPath = path.resolve(dirname, "../types/preferences/theme.ts");
...
const globalStylesPath = path.resolve(dirname, "../app/globals.css");
